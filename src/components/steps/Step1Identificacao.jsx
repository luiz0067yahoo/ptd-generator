    ...
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Informe os dados gerais do curso técnico e do corpo docente (Padrão PTD Senac).</p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50/70 border border-amber-200/90 rounded-2xl p-4 mb-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600">Gere todas as etapas do plano pedagógico oficial Senac de uma única vez.</p>
          </div>
        </div>
        <button
          type="button"
      ...
      <div className="bg-blue-50/70 border border-blue-100 rounded-xl p-3.5 mb-6 text-xs text-blue-900 flex items-start gap-2.5">
        ...
        <div>
          <strong className="font-semibold">Padrão Oficial Senac:</strong> Os campos abaixo correspondem exatamente à tabela inicial do <em>Plano de Trabalho Docente</em> (Nome do curso, Instrutor e Formato da aula).
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="Ex: Excel Recursos Avançados, Técnico em Desenvolvimento de Sistemas, etc."
          ...
          <p className="text-xs text-slate-400 mt-1">
            Exemplos: Excel Recursos Avançados, Técnico em Inteligência Artificial, Técnico em Administração.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Ex: Luiz Fernando Brogliatto Ferreira"
              className="w-full px-3.5 py-2.5 text-sm border border-slate-300 rounded-xl focus:ring-2 focus:ring-senac-blue focus:border-transparent outline-none transition"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ex: Presencial local Senac Toledo Sala 12"
              className="w-full px-3.5 py-2.5 text-sm border border-slate-300 rounded-xl focus:ring-2 focus:ring-senac-blue focus:border-transparent outline-none transition"
            />
            <p className="text-[11px] text-slate-400 mt-1">
              Ex: Presencial local Senac Toledo Sala 12, Presencial, EaD ou Híbrido.
            </p>
          </div>
        </div>
      </div>
